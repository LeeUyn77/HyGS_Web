<div class="product-main">
	<div class="wrap">
		<div class="section group">
			...
			<div class="col span_1_of_3">
				<div class="company_address">
					...
					<p>123 Nguyen Huu Canh</p>
					<p>Ward 22 Binh Thanh District Ho Chi Minh City</p>
					<p>Viet Name</p>
					<p>Phone: 077766654</p>
					<p>Fax: (000) 777 66 55 4</p>
					<p>
						Email: <span>hydragamingstore@gmail.com</span>
					</p>
					<p>
		...
		<div class="map">
			<iframe width="65%" height="275" frameborder="0" scrolling="no"
